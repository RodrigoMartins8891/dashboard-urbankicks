...
import MainLayout from '../components/layout/MainLayout'; // Importação essencial para manter o menu
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {customers.map((c) => (
                        <div key={c.id} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center text-center">
                            ...
                            <p className="text-slate-400 text-sm mb-4 flex items-center gap-1 justify-center">
